...
const Content = (() => {
  ...
  const INFO = {
    ...
    throttle: { t: 'Throttle', w: 'How much power or thrust the engine is asked to make.', y: 'If thrust is bigger than drag the aircraft climbs or speeds up; if smaller, it sinks or slows down.', r: 'Airliners cruise at about 85–90 % thrust.', f: 'Climb rate = speed × (thrust − drag) ÷ weight' },
    ...
    dragchart: { t: 'Drag and thrust', w: 'The drag in level flight and the thrust available, at each speed.', y: 'Slow flight costs “induced” drag (making lots of lift); fast flight costs skin drag. The aircraft can hold its height wherever thrust is above drag — the green band.', r: '', f: 'Drag = ½ × density × speed² × area × drag coefficient' },
